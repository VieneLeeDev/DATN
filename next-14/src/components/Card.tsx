...
const Card = (props: CartProps) => {
    return (
        <div
            className="container border-[1px] overflow-hidden hover:opacity-80 hover:cursor-pointer duration-100 h-full">
            <div
                className="flex relative bg-center bg-cover bg-[url('https://fl-1.cdn.flockler.com/embed/no-image.svg')] overflow-hidden aspect-square">
                <img
                    // fill
