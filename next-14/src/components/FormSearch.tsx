  ...
  ({
    ...
    const getUnitData = (array: any) => {
      const result = array.filter(
        (product: any, index: any) => array.indexOf(product) === index
      );
      return result;
    };
    ...
    //clean data city
    const pickHotel = dataHotel?.filter((hotel) =>
      dataRoom?.find((room) => room.hotel_id === hotel.id)
    );
          ...
          <div className="w-1/2 h-full">
            ...
            <div className="w-full h-2/3 px-3 bg-white ">
              ...
              >
                ...
                {unitCity.map((hotel: any, index: number) => (
